...
public class DriveSubsystem extends SubsystemBase {
  ...
  // The gyro sensor
  private final OnboardIMU gyro = new OnboardIMU(OnboardIMU.MountOrientation.kFlat);
    ...
    var swerveModuleStates = DriveConstants.DRIVE_KINEMATICS.toSwerveModuleStates(
        fieldRelative
            ? new ChassisSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered)
                .toFieldRelative(Rotation2d.fromDegrees(gyro.getAngleZ()))
            : new ChassisSpeeds(xSpeedDelivered, ySpeedDelivered, rotDelivered));
  ...
  public double getHeading() {
    return Rotation2d.fromDegrees(gyro.getAngleZ()).getDegrees();
  }
